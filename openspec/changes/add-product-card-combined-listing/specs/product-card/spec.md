...
- **THEN** the card shows capped sibling entries between the image and the title, each linking to that sibling's product page, with the current product's entry visually marked
